...
OUTPUT_FOLDER_TEMPLATE="/lustre/project/ki-topml/minbui/repos/DialectSalary/salary_estimation/output/{}"
GT_FILE_TEMPLATE="/lustre/project/ki-topml/minbui/repos/DialectSalary/salary_estimation/data/prompts/tasks/{}.csv"

# Iterate over tasks
for TASK in "${tasks[@]}"; do
  OUTPUT_FOLDER="${OUTPUT_FOLDER_TEMPLATE//\{\}/$TASK}"
  GT_FILE="${GT_FILE_TEMPLATE//\{\}/$TASK}"
