...
MODE="implicit_explicit_black"
SCRIPT_PATH="/lustre/project/ki-topml/minbui/repos/DialectSalary/salary_estimation/scripts/inference.py"
OUTPUT_FOLDER="/lustre/project/ki-topml/minbui/repos/DialectSalary/salary_estimation/output/${MODE}"
GT_FILE="/lustre/project/ki-topml/minbui/repos/DialectSalary/salary_estimation/data/prompts/tasks/${MODE}.csv"
